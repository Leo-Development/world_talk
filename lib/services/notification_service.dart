...
class NotificationsService {
  static const key =
      'AAAAmEkHTwA:APA91bERppT8sD2KYT969Oc5FzhVxbTpJoZB29L1Lt5OAdovEKwMEC5OtpPsUguvXDZskXSuXUqT8qO9DeYxjVh6EiYhKIsseVqres2PdjutC6FUpoNOwsU4ic6J0JqFg0Z0_SjdSsXn';
  ...
  void firebaseNotification(context) {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) async {
      await Navigator.of(context).push(
        MaterialPageRoute(
          builder: (_) => ChartScreen(message.data['senderId']),
        ),
      );
    });
